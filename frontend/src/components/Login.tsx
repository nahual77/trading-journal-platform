...
export default function Login({ onSwitchToRegister }: LoginProps) {
  ...
  return (
    <div className="h-screen w-screen relative overflow-hidden" style={{
      ...
      <div className="flex-1 flex flex-col lg:flex-row pt-20 lg:pt-32" style={{ minHeight: 'calc(100vh - 80px)' }}>
        {/* Panel izquierdo - Información de la empresa */}
        <div className="w-full lg:w-1/2 flex items-center justify-center lg:justify-start p-2 lg:p-8 lg:pr-4" style={{ minHeight: '400px' }}>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center lg:justify-end p-2 lg:p-8 lg:pl-4" style={{ minHeight: '400px' }}>
