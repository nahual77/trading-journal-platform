  ...
  return (
    <div className="h-screen w-screen relative overflow-hidden" style={{
      ...
      <div className="flex-1 flex flex-col lg:flex-row pt-20 lg:pt-32">
        ...
        <div className="flex-1 flex items-center justify-center p-2 lg:p-8 lg:justify-start">
        ...
        <div className="flex-1 flex items-center justify-center p-2 lg:p-8 lg:justify-end">
