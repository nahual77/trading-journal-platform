...
export default function Login({ onSwitchToRegister }: LoginProps) {
  ...
  return (
    <div className="h-screen w-screen relative overflow-hidden" style={{
      ...
      <div className="login-container flex-1 flex flex-col lg:flex-row pt-20 lg:pt-32 pb-8 lg:pb-0 min-h-screen">
        {/* Panel izquierdo - Información de la empresa */}
        <div className="login-text w-full lg:w-1/2 flex items-center justify-center lg:justify-start p-2 lg:p-8 lg:pr-4">
        ...
        <div className="login-form w-full lg:w-1/2 flex items-center justify-center lg:justify-end p-2 lg:p-8 lg:pl-4">
