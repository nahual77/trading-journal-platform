      ...
      >
        <div className="flex items-center space-x-2">
          ...
          <div className="hidden sm:block text-left">
                          <div className="text-base font-medium text-white truncate max-w-[120px]">
              {user?.email?.split('@')[0] || 'Usuario'}
            </div>
            <div className="text-sm text-gray-400">Trading Journal</div>
          </div>
        </div>
        ...
        >
          ...
          <div className="py-2">
            <button
              ...
              className="w-full flex items-center space-x-3 px-4 py-2 text-base text-gray-300 hover:bg-gray-700 hover:text-white transition-colors"
            >
